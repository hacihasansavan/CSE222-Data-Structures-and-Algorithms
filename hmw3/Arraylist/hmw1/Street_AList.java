 ...
 *
 * */
public class Street_AList extends Structure{

	private int length;
	//private int[] xAxis; /*it will either 1 or 0. 1 means it's full, 0 means empty*/
	private ArrayList<Structure> leftSideBuildings;  
	private ArrayList<Structure> rigthSideBuildings;
	 ...
	 * */
	public Street_AList(int _length){
		this.length = _length;
	 ...
	 * */
	public ArrayList<Structure> getRigthBuildings(){
		return rigthSideBuildings;
	}
	/**
	 * Time Complexity is Theta(1)
	 * */
	public ArrayList<Structure> getLeftBuildings(){
		return leftSideBuildings;
	}
	/**
	 * Time Complexity is Theta(1)
	 * */
	public void setRigthBuildings(ArrayList<Structure> s){
		rigthSideBuildings = s;
	}
	/**
	 * Time Complexity is Theta(1)
	 * */
	public void setLeftBuildings(ArrayList<Structure> s){
		leftSideBuildings = s;
	}
	 ...
	 * 
	 * */
	public static int findObjIndex(int sPoint, ArrayList<Structure> str){
		int rValue=-1;
	 ...
	 * 
	 * */
	public static int findFocusingIndex(int sPoint, ArrayList<Structure> str){
		int rValue=-1;
		for(int i=0; i<str.size();++i) {
			//System.out.println("find object index: "+str.get(i).getStartPos());
			if(sPoint == str.get(i).getStartPos()) {
	 ...
	 * */
	public void setLeftSideBuildings(ArrayList<Structure> leftBuildings) {
	 ...
	 * */
	public void setRightSideBuildings(ArrayList<Structure> rightBuildings) {
		this.rigthSideBuildings = rightBuildings;
	}
	/**
	 * Time Complexity is O(n^2)
	 * */
	public static boolean isValidPlace(ArrayList<Structure> arr,int position,int length) {
	 ...
	 * */
	private void createOffice(ArrayList<Structure> arr) {
	 ...
	 * @param arr is an MyArray that includes right Side or left side of Street structures
	 * */
	private void createMarket(ArrayList<Structure> arr){
		int position,length,heigth;
	 ...
	 * @param arr is an MyArray that includes right Side or left side of Street structures
	 * */
	private void createHouse(ArrayList<Structure> arr) {
	 ...
	 * @param arr is an MyArray that includes right Side or left side of Street structures
	 * */
	private void createPlayground(ArrayList<Structure> arr) {
		int position,length;
